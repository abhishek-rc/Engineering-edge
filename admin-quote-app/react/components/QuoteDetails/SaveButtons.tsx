    ...
    return (
      <Fragment>
        <span className="mr4">
          ...
          >
            <FormattedMessage id="admin/b2b-quotes.create.button.save-for-later" />
          </Button>
        </span>
        <span className="mr4">
          <Button
          ...
          >
            <FormattedMessage id="admin/b2b-quotes.create.button.request-quote" />
          </Button>
        </span>
      </Fragment>
    )
  ...
  return (
    <Fragment>
      <span className="mr4">
        ...
        >
          {isSalesRep ? (
            <FormattedMessage id="admin/b2b-quotes.quote-details.save" />
          ) : (
            <FormattedMessage id="admin/b2b-quotes.quote-details.submit-to-sales-rep" />
          )}
        </Button>
      </span>
    </Fragment>
