    ...
    <div className="mt3">
      {updateHistory.length > 0 && (
        <h3 className="t-heading-4">
          <FormattedMessage id="admin/b2b-quotes.quote-details.update-history.title" />
        </h3>
      )}
        ...
        return (
          <div key={index} className="ph4 pv2">
            <Card>
              <div>
                <FormattedMessage
                  id="admin/b2b-quotes.quote-details.update-history.update-details"
                  values={{
              ...
              {update.note && (
                <div>
                  <b>
                    <FormattedMessage id="admin/b2b-quotes.quote-details.update-history.notes" />
                  </b>
                  <br />
                  {update.note}
                </div>
